...
import net.corda.core.utilities.printHexBinary
...
internal class ConnectionStateMachine(private val serverMode: Boolean,
        ...
        while (sender.credit > 0) {
            ...
            if (nextMessage != null) {
                try {
                    ...
                    logDebugWithMDC { "Put tag ${printHexBinary(delivery.tag)} on wire uuid: ${nextMessage.applicationProperties["_AMQ_DUPL_ID"]}" }
    ...
    override fun onDelivery(event: Event) {
        ...
        if (link is Receiver) {
            ...
            logDebugWithMDC { "Sender delivery confirmed tag ${printHexBinary(delivery.tag)}" }
