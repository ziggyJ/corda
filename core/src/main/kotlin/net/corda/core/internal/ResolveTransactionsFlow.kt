 ...
 */
class ResolveTransactionsFlow(private val txHashes: Set<SecureHash>, private val otherSide: FlowSession, private val sendEnd: AtomicBoolean) : FlowLogic<List<SignedTransaction>>() {
    /**
